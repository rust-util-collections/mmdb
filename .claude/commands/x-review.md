...
4. **Re-evaluate Won't Fix**: read every `## Won't Fix` entry and verify it against the CURRENT code:
   - Has surrounding code changed enough to invalidate the original reasoning?
